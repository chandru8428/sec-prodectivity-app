      ...
      <div style="display:flex;width:100%;max-width:1040px;gap:24px;flex-wrap:wrap;justify-content:center;align-items:stretch;">
        ...
        <div class="glass-card" style="flex:1;min-width:320px;border-radius:24px;padding:48px;border:1px solid rgba(68,70,85,0.25);display:flex;flex-direction:column;justify-content:center;">
          <div>
            ...
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:48px;font-size:15px;">
              <span style="color:var(--color-on-surface-variant);">Developed by <strong>Chandru K</strong></span>
              <a href="https://www.linkedin.com/in/chandru-k2006" target="_blank" aria-label="LinkedIn" style="color:#0a66c2;display:flex;align-items:center;transition:opacity 0.2s;opacity:0.8;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.8'">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
              <a href="https://github.com/chandru8428" target="_blank" aria-label="GitHub" style="color:var(--color-on-surface);display:flex;align-items:center;transition:opacity 0.2s;opacity:0.8;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.8'">
