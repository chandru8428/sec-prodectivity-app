...
const adminNavItems = [
  ...
  { icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/></svg>', label: 'Announcements',    path: '/admin/announcements' },
    ...
    <div class="sidebar-footer">
      <div class="sidebar-user" id="sidebar-user-menu" style="position:relative;cursor:pointer" title="Account options">
        ...
        <div style="flex:1;min-width:0">
          <div class="text-body-sm" style="font-weight:600;color:var(--color-on-surface);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${user?.name || 'User'}</div>
          <div style="font-size:11px;color:var(--color-on-surface-variant);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${user?.registerNumber || user?.email || ''}</div>
        </div>
